 ...
 * Completely customizable `drush site-install` invokation.

 ## Requirements ##
This approach has been tested on OSX 10.8.3 in addtion to the desktop version of Ubuntu 64 12.10. Please download and install the suggested versions vs relying on package managers. Ubuntu, in particular, has a fair amount of old code in their repositories that will lead to your inability to use this software.
 ...
 * If you want to access access controled git repositories you will need to add your respective ssh keys via ssh-agent
